                ...
                <form method="POST" action="{{ route('productos.update', ['producto' => $producto-> id]) }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control" type="date" name="fecha_lanzamiento" value="{{ $producto->fecha_lanzamiento }}">
                        </div>
                    </div>
                    
                    <div class="form-group mb-3">
                        <label class="form-label">Descripción</label>
                        <textarea class=form-control name="descripcion" value="{{ $producto->descripcion }}"></textarea>
                    </div>
